...
public class CheckBoxesofEmployeeJobCpc {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[9]/a")).click();
	    driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[9]/ul/li[1]/a")).click();
	    driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[9]/ul/li[2]/a")).click();
