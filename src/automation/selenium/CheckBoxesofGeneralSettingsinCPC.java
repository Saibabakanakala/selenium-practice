...
public class CheckBoxesofGeneralSettingsinCPC {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 ...
		 driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[3]/a")).click();
         driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[3]/ul/li[1]/a")).click();
		 driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[3]/ul/li[2]/a")).click();
		 driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[3]/ul/li[3]/a")).click();
		 driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[3]/ul/li[4]/a")).click();
