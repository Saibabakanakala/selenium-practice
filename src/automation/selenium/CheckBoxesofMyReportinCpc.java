...
public class CheckBoxesofMyReportinCpc {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.driver.chrome", "chrome.exe");
		 ...
		 driver.findElement(By.xpath("/html/body/div[3]/div/div/ul/li[15]/a")).click();
		 driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[15]/ul/li[1]/a")).click();
        driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[15]/ul/li[2]/a")).click();
		driver.findElement(By.xpath("/html/body/div[3]/div/div/div/ul/li[15]/ul/li[3]/a")).click();
